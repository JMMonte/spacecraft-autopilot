...
export class Trajectory {
    /**
     * @param {THREE.Vector3[]} waypoints - Array of positions defining the trajectory.
     * @param {number} totalTime - Total time to traverse the trajectory (in seconds).
     */
    constructor(waypoints = [], totalTime = 100) {
